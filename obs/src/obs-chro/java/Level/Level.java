...
public class Level {
    ...
    private void loadEnemies(int blueValue, int i, int j){
        switch (blueValue){
            case 1 -> ghoulList.add(new Ghoul(j * TILE_SIZE, i * TILE_SIZE));
            case 2 -> summonersList.add(new Summoner(j * TILE_SIZE, i * TILE_SIZE));
            case 3 -> spittersList.add(new Spitter(j * TILE_SIZE, i * TILE_SIZE));
            case 4 -> shielderList.add(new Shielder(j * TILE_SIZE, i * TILE_SIZE));
            case 5 -> daggerList.add(new Dagger(j * TILE_SIZE, i * TILE_SIZE));
            case 6 -> hoardersList.add(new Hoarder(j * TILE_SIZE, i * TILE_SIZE));
            case 7 -> guardiansList.add(new Guardian(j * TILE_SIZE, i * TILE_SIZE));
            case 8 -> hivesList.add(new Hive(j * TILE_SIZE, i * TILE_SIZE));
        }
    }

    private void loadObjects(int greenValue, int i, int j) {
        switch (greenValue){
            case 1 -> lightBugsList.add(new LightBugs(j * TILE_SIZE, i * TILE_SIZE, false));
            case 2 -> flowerList.add(new Flower(j * TILE_SIZE, i * TILE_SIZE));
            case 3 -> jumpBaseList.add(new JumpBase(j * TILE_SIZE,i * TILE_SIZE));
            case 4 -> {
                int kind = ExtraMethods.random.nextInt(0,2);
                if (kind == 1) bugsList.add(new Bugs(j * TILE_SIZE, i * TILE_SIZE));
                else greenBugsList.add(new GreenBugs(j * TILE_SIZE, i * TILE_SIZE));
            }
            case 5,6,7 -> treesList.add(new Trees(j * TILE_SIZE, i * TILE_SIZE, random.nextInt(1,3)));
            case 8 -> lightBugsList.add(new LightBugs(j * TILE_SIZE, i * TILE_SIZE, true));
            ...
            case 11 -> {
                merchantsList.add(new Merchant(j * TILE_SIZE, i * TILE_SIZE));
                npc_buttonsList.add(new NPC_Buttons(NPC_Buttons.E, j * TILE_SIZE, (int) ((i - 0.5) * TILE_SIZE)));
            }
            case 12 -> doorsList.add(new Door(j * TILE_SIZE, i * TILE_SIZE, false));
            case 13 -> doorsList.add(new Door(j * TILE_SIZE, i * TILE_SIZE, true));
            case 14 -> portalsList.add(new Portal(j * TILE_SIZE, i * TILE_SIZE));
            case 15 -> {
                oldManList.add(new OldMan(j * TILE_SIZE, i * TILE_SIZE));
                npc_buttonsList.add(new NPC_Buttons(NPC_Buttons.E, j * TILE_SIZE, (int) ((i - 0.5) * TILE_SIZE)));
            }
    ...
    public ArrayList<Ghoul> ghoulList = new ArrayList<>();
    public ArrayList<Dagger> daggerList = new ArrayList<>();
    public ArrayList<Summoner> summonersList = new ArrayList<>();
    public ArrayList<Spitter> spittersList = new ArrayList<>();
    public ArrayList<Shielder> shielderList = new ArrayList<>();
    public ArrayList<Guardian> guardiansList = new ArrayList<>();
    public ArrayList<Flower> flowerList = new ArrayList<>();
    public ArrayList<LightBugs> lightBugsList = new ArrayList<>();
    public ArrayList<JumpBase> jumpBaseList = new ArrayList<>();
    public ArrayList<Bugs> bugsList = new ArrayList<>();
    public ArrayList<Trees> treesList = new ArrayList<>();
    public ArrayList<Merchant> merchantsList = new ArrayList<>();
    public ArrayList<Door> doorsList = new ArrayList<>();
    public ArrayList<Items> itemsList = new ArrayList<>();
    public ArrayList<Portal> portalsList = new ArrayList<>();
    public ArrayList<Hoarder> hoardersList = new ArrayList<>();
    public ArrayList<GreenBugs> greenBugsList = new ArrayList<>();
    public ArrayList<Skills> skillsList = new ArrayList<>();
    public ArrayList<Potions> potionsList = new ArrayList<>();
    public ArrayList<Weapons> weaponsList = new ArrayList<>();
    public ArrayList<OldMan> oldManList = new ArrayList<>();
    public ArrayList<NPC_Buttons> npc_buttonsList = new ArrayList<>();
    public ArrayList<Hive> hivesList = new ArrayList<>();
