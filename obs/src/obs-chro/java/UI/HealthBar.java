...
public class HealthBar {
    ...
    private void initClass() {
        ...
        healthWidth = (int) (Constant.HEALTH_BAR.WIDTH - 12 * MODE);
        healthHeight = (int) (Constant.HEALTH_BAR.HEIGHT - 6 * MODE);
    ...
    public void update(){
        ...
        healthWidth = (int) ((Constant.HEALTH_BAR.WIDTH - 12 * MODE) * (1.0 * currentHealth / maxHealth));
        updateAniTick();
    }
